        ...
        <nav className="flex items-center justify-between h-16 lg:h-20">
          <div className="flex items-center">
            ...
            <Link to="/" title="Home" className="flex items-center ml-4">
              <img
                className="h-12 lg:h-14 lg:w-28 hidden lg:block"
                src={logo}
                alt="Logo"
              />
              <img
                className={`w-auto h-8 lg:h-10 lg:hidden`}
                src={logo_img}
                alt="Logo"
              />
            </Link>
          ...
          <div
            className={`flex-grow ${isSearchOpen ? 'flex' : 'hidden'} lg:flex items-center justify-center`}
          >
            <SearchBar
          ...
          <div className="flex items-center space-x-4">
            ...
            {!isSearchOpen && (
              <div
                className="relative cursor-pointer text-slate-200"
            ...
            {isSearchOpen && (
              <div
                className="relative cursor-pointer text-slate-200 hidden lg:block"
                onClick={handleReadCount}
              >
                <IoNotificationsSharp size={30} className="mr-4" />
                {unreadCount > 0 && (
