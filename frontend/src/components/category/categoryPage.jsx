        ...
        {categories.length > 0 && (
          <>
            <div>
              ...
              <p className=" pl-4 pt-4 font-mono">
                Please Select the categories you like:
              </p>
            </div>
            <div className="pt-7 grid grid-cols-2 gap-4 pl-2 pr-2 pb-7 overflow-y-scroll  no-scrollbar">
              {categories.map((category) => (
                ...
                >
                  <img
                    className="h-20 w-20 rounded-full object-cover lg:pt-2 lg:pl-2"
                    src={category.media}
                    alt="Category Image"
                  />
            ...
            <div className="pt-4 pb-7 flex justify-center">
              <Link to="/">
                <button
                  ...
                  className="bg-blue-500 text-white my-2 px-8 py-2  hover:bg-blue-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  Submit
                </button>
              </Link>
