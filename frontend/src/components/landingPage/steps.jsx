...
const Steps = () => {
    return (
        <div className="flex flex-col gap-10 space-y-10 text-xl my-20 px-5 md:px-10">
            {/* Header Section */}
            <div className="flex flex-col md:flex-row gap-6 md:gap-36 items-start">
                ...
                <p className="md:w-[60%] leading-8 md:leading-10 text-lg md:text-2xl">
                ...
                <div className="w-full md:w-[40%] space-y-6 md:space-y-10 text-lg md:text-xl">
                    {stepsPart.map((step, index) => (
                        <div key={index} className="flex gap-4 items-start">
                            <div className="bg-[#7F3FBF] w-8 h-8 md:w-10 md:h-10 rounded-full flex justify-center items-center">
