...
const UserProfile = () => {
  ...
  return (
    <div className="w-full bg-[rgb(13,17,20)]  overflow-y-scroll no-scrollbar max-h-screen">
      <div className="bg-[#13181d] shadow-md w-[500px] min-w-[600px] h-[400px] rounded-lg mt-8 border-2 border-gray-600 ml-16">
        <div className="relative bg-[#0d1114] w-[480px] min-w-[595px] h-[150px] rounded-t-lg"> 
          {
